...
async def scrape_matches():
    ...
    async with async_playwright() as p:
        ...
        await page.goto("http://bunchatv1.net/", wait_until='domcontentloaded', timeout=30000)
        
        # Chờ React render - chờ grid-matches__item elements
        print("⏳ Chờ content load...")
        try:
            await page.wait_for_selector('.grid-matches__item', timeout=15000)
            print("✓ Content loaded")
        except:
            print("⚠️  Timeout chờ content")
